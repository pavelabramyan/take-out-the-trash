...
const LEVELS := [
	{
		...
		"hint_ru": "Правый марш вниз → площадка у окна → левый марш → дверь во двор → контейнеры (E).",
		"hint_en": "Right flight down → window landing → left flight → yard door → dumpsters (E).",
