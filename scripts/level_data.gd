...
const LEVELS := [
	{
		...
		"hint_ru": "E — пакет у двери. Правый марш вниз → окно → левый марш → ещё раз то же → дверь во двор → баки (E).",
		"hint_en": "E — bag at the door. Right flight down → window → left flight → repeat → yard door → dumpsters (E).",
		"note_ru": "Записка: клетка узкая, свет тусклый — ориентир окно на промежуточной.",
		"note_en": "Note: tight stairwell — use the mid-landing window as your cue.",
	...
	},
	{
		...
		"title_ru": "Подвал",
		"title_en": "Basement",
		"hint_ru": "Вниз в подвал, потом пандус во двор. Лужи скользкие.",
		"hint_en": "Down to the basement, then the ramp to the yard. Puddles are slick.",
