...
const LEVELS := [
	{
		...
		"hint_ru": "Иди на ЗЕЛЁНУЮ метку → вниз по ступеням. Не прыгай в дыру.",
		"hint_en": "Walk to the GREEN mark → down the stairs. Don't jump the hole.",
		"note_ru": "Записка: зелёная метка — вниз по лестнице.",
		"note_en": "Note: green mark means go down the stairs.",
		"floors": 2, "start_floor": 2, "cargo": "bag", "bag_hp": 120.0, "time_star": 100.0,
